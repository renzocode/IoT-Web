		...
		spa.shell = (function (){
			...
			var configMap = {
				anchor_schema_map : {
					...
					main : { 
							 manage : true, azure : true,
							 plc : true , nodemcu : true,
							 nodesnap7 : true, dashboard: true
						}
				},
				main_html : String() 
				+ '<div id="spa-shell-head-id" class="spa-shell-head">'
					+'<div id="spa-shell-head-id-logo">'
						+'<a style="font-weight:bold;" href="#!main=dashboard">IOT</a>'
					+'</div>'
				+ '</div>'
				+ '<div id="spa-shell-main-id" class="row spa-shell-main">'
					+ '<div id="spa-shell-main-nav-id" class="col-2 spa-shell-main-nav">'
						+'<ul>'
							  +'<li><a href="#home">All resources</a></li>'
							  +'<li><a href="#news">App Services</a></li>'
							  +'<li><a href="#contact">Virtual machines</a></li>'
							  +'<li><a href="#about">Virtual networks</a></li>'
							  +'<li><a href="#about">Monitor</a></li>'
							  +'<li><a href="#about">Security center</a></li>'
							  +'<li><a href="#about">API market</a></li>'
						+'</ul>'
					+'</div>'
					+ '<div id="spa-shell-main-content-id" class="col-8 spa-shell-main-content"></div>'
					+ '<div id="spa-shell-main-update-id" class="col-2 spa-shell-main-update">API</div>'
				+ '</div>'
			...
			setChatAnchor, setMainAnchor, 
			initModule, apiFunctionData;

			apiFunctionData = function(){				
				(function(){
						fetch('http://localhost:8080/api/customers').then(response => response.json())
						.then(users => {
							//console.log(users);
							let output = '<h2>Lists of APIS</h2>';
