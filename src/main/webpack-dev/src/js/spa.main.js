(function(root, factory){
	...
	//console.log(this.process.env);
		...
		spa.main = (function(){
			var configMap = {
				dashboard : String()
					+'<div class="spa-main-form" style="height:400px; background-color: #ddd;">'
						+'<div style="text-align:center;">IOT Dashboard</div>'
					+'</div>',

				templateManage : String()
					+'<div class="spa-main-form" style="height:400px; background-color: #ddd;">'
					+'<form  style="text-align:left; color:#000 !important;" id="formmanage">'
									+'Name manage:<br>'
				...
				templateAzure : String()
					+'<div class="spa-main-form" style="height:400px; background-color: #ddd;">'
					+'<form  style="text-align:left; color:#000;" id="formmazure">'
									+'Azure:<br>'
									+'<input style="margin:10px;" type="text" name="firstname" id="firstname">'
									+'<br>'
									+'Key :<br>'
				...
				,templatePLC : String()
					+'<div class="spa-main-form" style="height:400px; background-color: #ddd;">'
					+'<form  style="text-align:left; color:#000;" id="formplc">'
									+'Name PLC:<br>'
									+'<input style="margin:10px;" type="text" name="firstname" id="firstname">'
									+'<br>'
									+'Last name :<br>'
				...
				,templateNodeMCU : String()
					+'<div class="spa-main-form" style="height:400px; background-color: #ddd;">'
					+'<form  style="text-align:left; color:#000;" id="formnodemcu">'
									+'Name NodeMCU:<br>'
									+'<input style="margin:10px;" type="text" name="firstname" id="firstname">'
									+'<br>'
									+'Last name :<br>'
				...
				templateNodeSnap7 : String()
					+'<div class="spa-main-form" style="height:400px; background-color: #ddd;">'
					+'<form  style="text-align:left; color:#000;" id="formnodesnap7">'
									+'Snap7:<br>'
									+'<input style="margin:10px;" type="text" name="firstname" id="firstname">'
									+'<br>'
									+'IP :<br>'
				...
				main_html : String() 
					+ '<div class="spa-main">'
						...
						+'<div class="spa-main-body row">'
							+'<div class="col-3" style="float: left; padding: 20px; height: 550px; text-align:center;">'
								+'<p style="color:#000; font-size:30px;	">Welcome</p>'
							+'</div>'
			...
			setJqueryMap, onTagSave, initModule, setLocalStorage1;
